 ...
 * @author nathb
 */
public class DeconnectionFrame extends javax.swing.JFrame {
    FenetrePrincipale main;

    /**
     * Creates new form DeconnectionFrame
     */
    public DeconnectionFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeconnectionFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeconnectionFrame().setVisible(true);
            }
        });
    }
